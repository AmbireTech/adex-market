...
async function detectExtraFlags(publisherAddr, websiteUrl) {
	...
	const INCENTIVIZED_REGEX = /earn (bitcoin|money|free|extra|up to|upto|even|(\d )?satoshi|only)|PayPerView|paid to click|ptc ads|faucet( )?pay|paid faucet|(bitcoin|dogecoin|litecoin) faucet/gi
	try {
