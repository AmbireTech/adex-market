...
function isOffline (messagesFromAll) {
	const { leaderFromLeader, followerFromLeader } = messagesFromAll
	const recentLeaderHb = getRecentHeartbeats(leaderFromLeader)
	const recentFollowerHb = getRecentHeartbeats(followerFromLeader)
	console.log(recentLeaderHb, recentFollowerHb)
...
function isDisconnected (messagesFromAll) {
	const { leaderFromFollower, followerFromFollower } = messagesFromAll

	const recentLeaderHb = getRecentHeartbeats(leaderFromFollower)
	const recentFollowerHb = getRecentHeartbeats(followerFromFollower)
